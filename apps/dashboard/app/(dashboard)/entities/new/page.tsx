        ...
        <div style={{ padding: "2rem", maxWidth: "800px" }}>
          ...
          >
            ...
            <p style={{ color: "#ccc", lineHeight: 1.6, marginBottom: 0 }}>
              Only Admin and Compliance Officer accounts can create new entity
              drafts.
            </p>
          </div>
        </div>
      ...
      <div style={{ padding: "2rem", maxWidth: "900px" }}>
        ...
        <div style={{ marginBottom: "1.5rem" }}>
          ...
          <p style={{ color: "#aaa", margin: 0, lineHeight: 1.6 }}>
            Drafts can still be created during the pilot launch. KYC submission
            stays disabled until Sumsub is re-enabled.
          </p>
        </div>
        ...
        >
          Phase 0 currently supports EU entities only, so new drafts are created
          with the EU jurisdiction locked in.
        </div>
