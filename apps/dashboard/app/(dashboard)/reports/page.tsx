      ...
      <div style={{ maxWidth: "1000px", margin: "0 auto", padding: "2rem" }}>
        ...
        >
          <div>
            ...
            <p style={{ color: "#888", marginTop: "0.5rem" }}>
              Generate and download monthly operational summaries.
            </p>
          </div>
          <CreateReportForm />
        </header>
        ...
        >
          ...
          >
            ...
            >
              <tr>
                <th style={{ padding: "1rem", fontWeight: 500, color: "#888" }}>
                  Month
                </th>
                <th style={{ padding: "1rem", fontWeight: 500, color: "#888" }}>
                  Status
              ...
              {reports.map((report) => (
                <tr key={report.id} style={{ borderBottom: "1px solid #222" }}>
                      ...
                      style={{
                        ...
                        background:
                          report.status === ReportJobStatus.Generated
                            ? "#003300"
                            : report.status === ReportJobStatus.Failed
                              ? "#330000"
                              : "#333",
                        color:
                          report.status === ReportJobStatus.Generated
                  ...
                  <td style={{ padding: "1rem", color: "#ccc" }}>
                    {report.metrics?.entityCount || 0}
                  </td>
                  <td style={{ padding: "1rem", color: "#ccc" }}>
                    {report.metrics?.totalCaseCount || 0} /{" "}
                    {report.metrics?.openCaseCount || 0}
                  </td>
                  <td
                    style={{
                      padding: "1rem",
