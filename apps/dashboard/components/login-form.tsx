    ...
    >
      ...
      <div
        style={{
          ...
          borderRadius: "12px",
          background:
            "linear-gradient(135deg, rgba(13, 110, 253, 0.22) 0%, rgba(85, 34, 204, 0.26) 55%, rgba(19, 194, 194, 0.22) 100%)",
      ...
      >
        ...
        >
          See the main TreasuryOS site for the product story, positioning, and
          launch vision before you sign in.
        </p>
        <a
          href={MAIN_SITE_URL}
          target="_blank"
      ...
      >
        ...
        >
          <label
            htmlFor="email"
            style={{ fontSize: "0.875rem", fontWeight: 500, color: "#ccc" }}
          >
            Email
          </label>
          <input
      ...
      {showDemoAccess && (
        <>
          ...
          >
            Demo access signs visitors in with a server-managed account so they
            can explore the product without seeing the password.
          </p>
        </>
      )}
    </div>
